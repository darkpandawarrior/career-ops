...
## [0.7.0](https://github.com/darkpandawarrior/career-ops/compare/web-v0.6.1...web-v0.7.0) (2026-08-14)


### Features

* **compliance:** check-table-freshness.mjs — staleness validator for jurisdiction tables (closes [#2036](https://github.com/darkpandawarrior/career-ops/issues/2036)) ([1e83f67](https://github.com/darkpandawarrior/career-ops/commit/1e83f6711e5e1587fc1d220b40eb925b8ef73542))
* **oferta/apply:** immigration-status requirement overreach — jurisdiction table + posting signal + form warning ([2a681d1](https://github.com/darkpandawarrior/career-ops/commit/2a681d129a5ad2fb1b191072dac74a0a90ea6cb5))
* **oferta/apply:** jurisdiction-prohibited content signal — table + Block G + apply-form warning ([d8dac75](https://github.com/darkpandawarrior/career-ops/commit/d8dac7589b228051abe79ca3acf4014cf8b9c6fb))
* **oferta:** agency licensing check — jurisdiction table + registry pointer for agency-mediated postings (closes [#2037](https://github.com/darkpandawarrior/career-ops/issues/2037)) ([10bf77f](https://github.com/darkpandawarrior/career-ops/commit/10bf77fb7c5c2f8eb6ca1a03ba91736f5bf95ca3))
* **providers:** add VDAB zero-auth provider ([#2084](https://github.com/darkpandawarrior/career-ops/issues/2084)) ([6164384](https://github.com/darkpandawarrior/career-ops/commit/6164384768fa47b7e164e2c36f53e86b2fd620cc))
* **web:** Follow-up Tracker page with logging, history, and cadence settings ([#1422](https://github.com/darkpandawarrior/career-ops/issues/1422)) ([6554de6](https://github.com/darkpandawarrior/career-ops/commit/6554de6dcd28b95556e95ae220aebc719cc7a2a0))


### Bug Fixes

* **dashboard:** localize the hired status label and buffer split stream openers ([#2295](https://github.com/darkpandawarrior/career-ops/issues/2295)) ([8f5d10d](https://github.com/darkpandawarrior/career-ops/commit/8f5d10d6aa97438a4ac3908814456df5a8cf4083))
* **deps:** make js-yaml imports work on both 4.x and 5.x ([#2656](https://github.com/darkpandawarrior/career-ops/issues/2656)) ([6466b18](https://github.com/darkpandawarrior/career-ops/commit/6466b18382aa2cb9390f5d2425a63ae36bcea085))
* **deps:** patch both HIGH advisories in web (js-yaml 4.3.1, nanoid 3.3.18) ([a094ec9](https://github.com/darkpandawarrior/career-ops/commit/a094ec9ddbe8f21e8db6dba87f548532af2a820e))
* **deps:** raise the js-yaml floor to ^4.3.1 and guard it ([#2767](https://github.com/darkpandawarrior/career-ops/issues/2767)) ([5b18a96](https://github.com/darkpandawarrior/career-ops/commit/5b18a960da803477a475a1856138561f83edc035))
* **deps:** update dependency next to v16.2.11 [security] ([#2198](https://github.com/darkpandawarrior/career-ops/issues/2198)) ([b6d1c87](https://github.com/darkpandawarrior/career-ops/commit/b6d1c871d985c278af51d26fa51ef09274c1076b))
* **deps:** update npm dependencies (+ Dockerfile playwright pins, web lockfile sync) ([f154f59](https://github.com/darkpandawarrior/career-ops/commit/f154f5938fed43a37ab5e57efee1c45d664cdc3f))
* **keys:** stop the dotted-I fix from collapsing Polish, Lithuanian and Maltese ([5df43e7](https://github.com/darkpandawarrior/career-ops/commit/5df43e7133745ad814421f2dd4c5afce2e75c0e1))
* **keys:** stop the Turkish dotted capital from splitting one employer in two ([462d276](https://github.com/darkpandawarrior/career-ops/commit/462d27653eda17c3305dfe74f2ecdc5b21fb79e6))
* **scan:** take the shared lock for scan-history.tsv appends ([#2639](https://github.com/darkpandawarrior/career-ops/issues/2639)) ([8e264c4](https://github.com/darkpandawarrior/career-ops/commit/8e264c4b24a04fc6f0799b2e5c9a0479ed4e16e0))
* **web:** add Grok Build CLI to the web runtime picker ([#2688](https://github.com/darkpandawarrior/career-ops/issues/2688)) ([af0d818](https://github.com/darkpandawarrior/career-ops/commit/af0d8183937a43397a127e75967b906fece86364))
* **web:** add Hired to the states.ts FALLBACK so the degraded path accepts it ([#2282](https://github.com/darkpandawarrior/career-ops/issues/2282)) ([fd112c9](https://github.com/darkpandawarrior/career-ops/commit/fd112c972d23cf0028e0411f36f67b1adf5520db))
* **web:** analytics tells an offer-holder they have 0 interviews (and nudges them to try harder) ([#2410](https://github.com/darkpandawarrior/career-ops/issues/2410)) ([8f2b415](https://github.com/darkpandawarrior/career-ops/commit/8f2b41505997c0f15d86ee617304701239328a12))
* **web:** derive company matching keys from the core, not an ASCII-only copy ([#2667](https://github.com/darkpandawarrior/career-ops/issues/2667)) ([9b6582c](https://github.com/darkpandawarrior/career-ops/commit/9b6582c01c381e6ab22ed674be7f7ef9f13d48df))
* **web:** detect OpenCode in its default install directory ([#1794](https://github.com/darkpandawarrior/career-ops/issues/1794)) ([c10b887](https://github.com/darkpandawarrior/career-ops/commit/c10b88764a793e4176688f60aa066e96eff1c3a4))
* **web:** emit the posting URL in the tracker-additions TSV so web runs join the dedup ([#2833](https://github.com/darkpandawarrior/career-ops/issues/2833)) ([3c68721](https://github.com/darkpandawarrior/career-ops/commit/3c68721fc28b98fc127ff9f5a36ac71188215750))
* **web:** enforce that no runtime grants itself blanket write permission ([#2875](https://github.com/darkpandawarrior/career-ops/issues/2875)) ([9ba6ebf](https://github.com/darkpandawarrior/career-ops/commit/9ba6ebf2f94dbd2772af9b32572af25429b303fc))
* **web:** finish Unicode company keys for explore + registry ([#2668](https://github.com/darkpandawarrior/career-ops/issues/2668)) ([c294242](https://github.com/darkpandawarrior/career-ops/commit/c294242dbb6a78a03bac738f397c568c02316971))
* **web:** fold Turkish dotted capitals in status keys, and stop hand-copying the state list ([#2786](https://github.com/darkpandawarrior/career-ops/issues/2786)) ([e1a0961](https://github.com/darkpandawarrior/career-ops/commit/e1a09616818d2dd84b249a7805078bbfeefae669))
* **web:** label-aware pipeline.md reader — posted:/trust:/note: never misread as columns ([6c75d9a](https://github.com/darkpandawarrior/career-ops/commit/6c75d9aa03c919803ffe6939b2ba6f1cf7238db6))
* **web:** let the pipeline table scroll horizontally instead of clipping on narrow screens ([#2363](https://github.com/darkpandawarrior/career-ops/issues/2363)) ([632031c](https://github.com/darkpandawarrior/career-ops/commit/632031c9cb8ae95311a36310bb6cd2713497136c))
* **web:** make the tracker reader agree with parseTrackerRow on row shape ([#2565](https://github.com/darkpandawarrior/career-ops/issues/2565)) ([4fea438](https://github.com/darkpandawarrior/career-ops/commit/4fea43835e940be62011f12afab4f35cb265c4ac))
* **web:** prevent Codex run jobs from waiting on stdin ([#1973](https://github.com/darkpandawarrior/career-ops/issues/1973)) ([9a139a2](https://github.com/darkpandawarrior/career-ops/commit/9a139a2aac44ae5e8da8e372a587a322ba99f149))
* **web:** propagate the Hired terminal-success state across the whole dashboard ([#2250](https://github.com/darkpandawarrior/career-ops/issues/2250)) ([29503dc](https://github.com/darkpandawarrior/career-ops/commit/29503dca07c4f1725675299db48685565f159acb))
* **web:** re-read states.yml when it changes instead of caching it for the process lifetime ([#2590](https://github.com/darkpandawarrior/career-ops/issues/2590)) ([2a2e09e](https://github.com/darkpandawarrior/career-ops/commit/2a2e09e61275e18a2331c1fee39bec3225f9f01c))
* **web:** read target_roles with the shape it is actually written in ([#2750](https://github.com/darkpandawarrior/career-ops/issues/2750)) ([5f5c06d](https://github.com/darkpandawarrior/career-ops/commit/5f5c06d4b257b4ef55dfedc2f1d1c0eb26bc9789))
* **web:** render PDFs from the backend instead of the spawned agent ([#2182](https://github.com/darkpandawarrior/career-ops/issues/2182)) ([fef3ff2](https://github.com/darkpandawarrior/career-ops/commit/fef3ff2e228cc14e55df4ced958e4b0aa630ec65))
* **web:** resolve nested postcss and sharp advisories via overrides ([#2216](https://github.com/darkpandawarrior/career-ops/issues/2216)) ([ec02af8](https://github.com/darkpandawarrior/career-ops/commit/ec02af816abc81b500475f81bf1c2753727a1e79))
* **web:** route Today's "See all N" link to the fresh-matches view ([#1790](https://github.com/darkpandawarrior/career-ops/issues/1790)) ([5fcc727](https://github.com/darkpandawarrior/career-ops/commit/5fcc72773b711be59f8212536df27ea6fd79f88d))
* **web:** skip {n}-RESERVED.md sentinels when looking up reports ([#1967](https://github.com/darkpandawarrior/career-ops/issues/1967)) ([5f4842e](https://github.com/darkpandawarrior/career-ops/commit/5f4842e513fe45092395254ba51bc220676e598a))
* **web:** stop the 16-chip cap from truncating the user's own portals.yml ([#2749](https://github.com/darkpandawarrior/career-ops/issues/2749)) ([a5af949](https://github.com/darkpandawarrior/career-ops/commit/a5af94900b981105f2560ee271e22a00479093a9))
* **web:** strip the author letter from any lettered block, not just A-G ([#2420](https://github.com/darkpandawarrior/career-ops/issues/2420)) ([630709a](https://github.com/darkpandawarrior/career-ops/commit/630709a3cad0297b7305752cfdf6ed5b0469b4d8))
* **web:** take Write/Edit away from the dashboard's pdf mode ([#2508](https://github.com/darkpandawarrior/career-ops/issues/2508)) ([1301ed4](https://github.com/darkpandawarrior/career-ops/commit/1301ed4ccc4b1ead8b7eca024135ad4d1d63932c))
